                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="assigned_to" id="assigned_to"
                                        class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                                        required>
                                    <option value="all_users" {{ old('assigned_to') == 'all_users' ? 'selected' : '' }}>
                                        {{ __('Semua User') }}
                                    </option>
                                    <option value="specific_users" {{ old('assigned_to') == 'specific_users' ? 'selected' : '' }}>
                                        {{ __('User Tertentu') }}
                                    </option>
                                </select>
                                @error('assigned_to')
                            ...
                            <!-- User Tertentu -->
                            <div id="users_section" class="md:col-span-2" style="display: {{ old('assigned_to') == 'specific_users' ? 'block' : 'none' }};">
